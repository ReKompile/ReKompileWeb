    ...
    <div className="page-body relative flex-col">
      ...
      <div className="flex flex-wrap justify-center align-center mb-10">
        <TeamMember
          ...
          role="Co-founder"
        >
          A high school student who loves to code and is passionate about
          helping others.
        </TeamMember>
        <TeamMember
          name="Ali Rastegar"
          ...
          role="Co-founder"
        >
          Ali thinks descriptions are boring. He mentions, though, that he codes
          every day.
        </TeamMember>
        <TeamMember
          name="Abid Raza Mir"
        ...
        >
          Abid is a software engineer who is a co-founder of a startup and a
          mentor at ReKompile.
        </TeamMember>
        <TeamMember
          name="Abbas Abidi Mir"
          portrait="/team/abbas abidi mir.png"
