        ...
        <>
            <div className='page-body relative'>
                <div className="flex justify-items-end items-stretch h-5/6 bg-[url('/decorations/ellipse1.svg')] bg-contain bg-no-repeat">
                    <Blob blobType={1} size='1/4' className='left-40' style={{top: '-10%'}}/>
                ...
                <div className='relative'>
                    <Blob blobType={3} size='1/2' className='top-40' style={{left: '-20%'}}/>
                    <Blob blobType={4} size='1/2' className='top-80' style={{right: '-25%'}}/>
